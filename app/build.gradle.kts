...
android {
    namespace = "com.example.backpaker_android"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.backpaker_android"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(libs.android.v1171)
    implementation(libs.maps.compose.v1171)
